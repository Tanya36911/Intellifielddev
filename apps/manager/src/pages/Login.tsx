...
import { z } from 'zod'
import { ApiError, login } from '@intelli/api-client'
    ...
    <div className={styles.wrap}>
      <form className={styles.card} onSubmit={onSubmit} noValidate>
        <div className={styles.wordmark}>
          Intelli <span className={styles.badge}>Manager</span>
        </div>
        <p className={styles.sub}>Sign in to review and run your branch.</p>
        ...
        <div className={styles.devHint}>
          ...
          <span>
            Demo login: <code>sarah@lumenbeauty.com / demo1234</code>
          </span>
        </div>
      </form>
    </div>
